...
const Signup = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    password: '',
    role: roleFromUrl === 'student' ? 'student' : roleFromUrl === 'startup' ? 'startup' : 'student',
  });
    ...
    <div className="min-h-screen bg-white text-gray-900 flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="max-w-md w-full">
          <h1 className="text-3xl font-bold mb-2 text-gray-900">Join StuGig</h1>
          <p className="text-gray-600 mb-8">
            Already have an account? <Link to="/login" className="text-primary-800 underline hover:text-primary-900">Sign In instead</Link>
          </p>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button
              ...
              className={`py-3 px-4 rounded-lg border-2 flex items-center justify-center gap-2 transition ${
                formData.role === 'startup' || formData.role === 'recruiter'
                  ? 'border-primary-800 bg-primary-800 text-white'
                  : 'border-gray-300 hover:border-primary-800'
              }`}
            >
              <Briefcase className="w-5 h-5" />
              <span className="font-medium">I want to Hire</span>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <span className="font-medium">I want to Work</span>
            </button>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Jane"
                  required
                  className="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:border-primary-800 focus:ring-1 focus:ring-primary-800 focus:outline-none"
                />
              </div>
              <div>
